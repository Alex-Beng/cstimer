...
var cubeutil = (function() {
	...
	var c222layerMask = toEqus("---------" + "------R-R" + "------F-F" + "D-D---D-D" + "------L-L" + "------B-B");
	...
	function get222Progress(facelet, method) {
		...
		if (method == 'cll') {
			return getProgressNAxis(facelet, get222ProgressCLL, 6);
		}
		return getProgressNAxis(facelet, get222ProgressOrtega, 6);
	}
